	...
	function (canvasItems, cursorCoords) {
		...
		var moveTopLeft = F2(
			function (point, by) {
				return _Utils_update(
					point,
					{x: point.x - by, y: point.y - by});
			});
		var moveBottomRight = F2(
			function (point, by) {
				return _Utils_update(
					point,
					{x: point.x + by, y: point.y + by});
			});
		var findFirstClosestItem = F2(
			function (item, found) {
				if (found.$ === 'Just') {
					return found;
				} else {
...
var author$project$Main$copySelectedCanvasItemInstances = function (model) {
	...
	return _Utils_update(
		model,
		{
			instantiatedItems: A2(elm$core$List$append, newItems, model.instantiatedItems),
...
var author$project$Main$deleteSelectedCanvasItemInstances = function (model) {
	return _Utils_update(
		model,
		{
			instantiatedItems: A2(
				elm$core$List$filter,
				function (x) {
					return !A2(elm$core$List$member, x, model.selectedItems);
				},
...
var author$project$Main$resizeCanvasItem = F5(
	function (zoomFactor, originalItem, startingCoords, currentCoords, anchor) {
		...
		switch (originalItem.$) {
			case 'Rect':
				var upperLeft = originalItem.a;
				var lowerRight = originalItem.b;
				switch (anchor.$) {
					case 'UpperLeft':
						return A2(
							author$project$Main$Rect,
					...
					case 'LowerLeft':
						return A2(
							...
							{
								x: lowerRight.x,
								y: A2(elm$core$Basics$max, upperLeft.y + threshold, lowerRight.y + deltaY)
							});
					default:
						return A2(
							author$project$Main$Rect,
...
var author$project$Main$updateCanvasItemInstance = F3(
	function (model, target, f) {
		...
		return _Utils_update(
			model,
			{
				instantiatedItems: A2(elm$core$List$map, process, model.instantiatedItems),
	...
	function (model, starting, ending) {
		...
		var process = function (item) {
			if (A2(author$project$Main$isSelectedCanvasItemInstance, model, item)) {
				...
				return _Utils_Tuple2(
					updatedItem,
					elm$core$Maybe$Just(updatedItem));
			} else {
				return _Utils_Tuple2(item, elm$core$Maybe$Nothing);
			}
		};
		var _n0 = elm$core$List$unzip(
			A2(elm$core$List$map, process, model.instantiatedItems));
		var updatedItems = _n0.a;
		var selectedItemMaybes = _n0.b;
		var selectedItems = A2(elm$core$List$filterMap, elm$core$Basics$identity, selectedItemMaybes);
		return _Utils_update(
			model,
...
var author$project$Main$update = F2(
	function (message, model) {
		switch (message.$) {
			...
			case 'UpdateItemName':
				var item = message.a;
				var newName = message.b;
				var updateName = function (i) {
					return _Utils_update(
						i,
						{name: newName});
				};
			...
			case 'UpdateItemGitUrl':
				var item = message.a;
				var newGitUrl = message.b;
				var updateGitUrl = function (i) {
					return _Utils_update(
						i,
						{gitUrl: newGitUrl});
				};
			...
			case 'UpdateItemGitRef':
				var item = message.a;
				var newGitRef = message.b;
				var updateGitRef = function (i) {
					return _Utils_update(
						i,
						{gitRef: newGitRef});
				};
			...
			case 'UpdateItemContextDir':
				var item = message.a;
				var newContextDir = message.b;
				var updateContextDir = function (i) {
					return _Utils_update(
						i,
			...
			case 'UpdateItemManifestPath':
				var item = message.a;
				var newManifestPath = message.b;
				var updateManifestPath = function (i) {
					return _Utils_update(
						i,
			...
			case 'UpdateSourcePinName':
				var item = message.a;
				var newName = message.b;
				var updateSourcePinName = function (i) {
					return _Utils_update(
						i,
			...
			case 'UpdateSinkPinName':
				var item = message.a;
				var newName = message.b;
				var updateSinkPinName = function (i) {
					return _Utils_update(
						i,
						{sinkPinName: newName});
				};
			...
			case 'MouseMove':
				...
				var newModel = function () {
					var _n2 = _Utils_Tuple2(updatedModel.cursorMode, updatedModel.intent);
					switch (_n2.b.$) {
						case 'ToMovePath':
							var _n3 = _n2.b;
							var id = _n3.a.id;
						...
						case 'ToPanViewBox':
							var _n6 = _n2.b;
							var startingPanCoords = _n6.a;
							var startingCoords = _n6.b;
							return _Utils_update(
								updatedModel,
								{
									panCoords: {x: startingPanCoords.x - (coords.x - startingCoords.x), y: startingPanCoords.y - (coords.y - startingCoords.y)}
								});
						case 'ToCreatePolyline':
							var _n7 = _n2.b;
							var points = _n7.b;
							return _Utils_update(
								updatedModel,
			...
			case 'MouseDown':
				var coords = message.a;
				var _n15 = _Utils_Tuple3(model.cursorMode, model.intent, model.selectedItems);
				switch (_n15.b.$) {
					case 'ToCreatePolyline':
						var _n16 = _n15.b;
						var dropPoint = _n16.a;
						var points = _n16.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
			...
			case 'MouseUp':
				var coords = message.a;
				var _n18 = _Utils_Tuple2(model.cursorMode, model.intent);
				_n18$5:
				while (true) {
					switch (_n18.b.$) {
						case 'ToMovePath':
							...
							if (_n18.a.$ === 'DragCursor') {
								...
								return author$project$Main$updateModelOnly(
									_Utils_update(
										model,
										{
											instantiatedItems: A2(elm$core$List$cons, item, model.instantiatedItems)
										}));
							} else {
								break _n18$5;
							}
...
var author$project$Main$boundingBoxToEllipse = F2(
	function (upperLeft, lowerRight) {
		...
		var centerY = upperLeft.y + radiusY;
		var centerX = upperLeft.x + radiusX;
		return _Utils_Tuple3(
			{x: centerX, y: centerY},
			radiusX,
			radiusY);
...
var author$project$Main$movementCircleAttributes = function (toDisplay) {
	return _List_fromArray(
		[
			...
			elm$svg$Svg$Attributes$visibility(
...
var author$project$Main$makeResizeCircles = F6(
	function (cursorCoords, item, width, height, toDisplay, anchor) {
		...
		var offsetX = _n0.a;
		var offsetY = _n0.b;
		var x = elm$core$String$fromInt(offsetX - 5);
		var y = elm$core$String$fromInt(offsetY - 5);
		return A2(
			elm$svg$Svg$path,
			_Utils_ap(
	...
	function (model, item) {
		...
		switch (_n0.$) {
			case 'Rect':
				var upperLeft = _n0.a;
				var lowerRight = _n0.b;
				var y = elm$core$String$fromInt(upperLeft.y);
				var x = elm$core$String$fromInt(upperLeft.x);
				var width = elm$core$String$fromInt(lowerRight.x - upperLeft.x);
				var resizeOption = A2(toDisplayResizeOption, upperLeft, lowerRight);
				var height = elm$core$String$fromInt(lowerRight.y - upperLeft.y);
				var cy = elm$core$String$fromInt(((lowerRight.y - upperLeft.y) / 2) | 0);
				var cx = elm$core$String$fromInt(((lowerRight.x - upperLeft.x) / 2) | 0);
				return A2(
					elm$svg$Svg$g,
					_List_fromArray(
						[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$fill('white'),
										elm$svg$Svg$Attributes$fillOpacity('1.0'),
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$transform('translate(' + (cx + (',' + (cy + ')')))),
			...
			case 'Polyline':
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								elm$svg$Svg$Attributes$fontSize('8pt'),
								elm$svg$Svg$Attributes$stroke(
								isSelected ? 'blue' : 'black'),
				...
				var starting = _n1.a;
				var ending = _n1.b;
				var pinNamesWithPoints = _List_fromArray(
					[
						A2(
						elm$core$Maybe$map,
						function (x) {
							return _Utils_Tuple2(x, item.sourcePinName);
						},
						starting),
						A2(
						elm$core$Maybe$map,
						function (x) {
							return _Utils_Tuple2(x, item.sinkPinName);
						},
						ending)
					]);
				var nameTexts = A2(
					elm$core$List$filterMap,
					elm$core$Maybe$map(makePinNameText),
					pinNamesWithPoints);
				return A2(
					elm$svg$Svg$g,
					_List_fromArray(
					...
					_Utils_ap(
						...
						_Utils_ap(movementCircles, nameTexts)));
			case 'Ellipse':
				var upperLeft = _n0.a;
				var lowerRight = _n0.b;
				var resizeOption = A2(toDisplayResizeOption, upperLeft, lowerRight);
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$core$String$fromInt(radiusX)),
										elm$svg$Svg$Attributes$cy(
										elm$core$String$fromInt(radiusY)),
								...
								_List_fromArray(
									[
										elm$svg$Svg$Attributes$transform(
										'translate(' + (elm$core$String$fromInt(radiusX) + (',' + (elm$core$String$fromInt(radiusY) + ')')))),
										elm$svg$Svg$Attributes$textAnchor('middle'),
										elm$svg$Svg$Attributes$alignmentBaseline('middle')
									]),
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										elm$core$String$fromInt(lowerRight.x - upperLeft.x)),
										elm$svg$Svg$Attributes$height(
										elm$core$String$fromInt(lowerRight.y - upperLeft.y)),
										elm$svg$Svg$Attributes$fillOpacity('0.0'),
										elm$svg$Svg$Attributes$strokeOpacity('0.0')
									]),
								_List_Nil)
						...
						[
							...
							_List_fromArray(
								[
									...
									'canvas-item-text-' + elm$core$String$fromInt(item.id))
								]),
							_List_fromArray(
								[
...
var author$project$Main$canvas = function (model) {
	var viewBoxDims = A2(
		...
		_List_fromArray(
			[
				elm$core$String$fromInt(model.panCoords.x),
				elm$core$String$fromInt(model.panCoords.y),
				elm$core$String$fromFloat(model.zoomFactor),
				elm$core$String$fromFloat(model.zoomFactor)
			]));
	var canvasItems = A2(
		elm$core$List$map,
	...
	var backgroundItems = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$id('background-graph-paper'),
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$svg$Svg$Attributes$d('M96 95h4v1h-4v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4h-9v4h-1v-4H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15v-9H0v-1h15V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h9V0h1v15h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9h4v1h-4v9zm-1 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-9-10h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm9-10v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-9-10h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm9-10v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-9-10h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm9-10v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-10 0v-9h-9v9h9zm-9-10h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9zm10 0h9v-9h-9v9z')
						]),
					_List_Nil),
					A2(
					elm$svg$Svg$path,
					_List_fromArray(
						[
							...
							elm$svg$Svg$Attributes$d('M6 5V0H5v5H0v1h5v94h1V6h94V5H6z')
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$fill('url(#background-graph-paper)'),
					elm$svg$Svg$Attributes$width('100%'),
					elm$svg$Svg$Attributes$height('100%')
				]),
			_List_Nil)
	...
	var polylineUnderConstruction = _n0.a;
	var pointUnderCursorCoords = _n0.b;
	var specialItems = _List_fromArray(
		[
			A2(
			elm$svg$Svg$marker,
			_List_fromArray(
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$id('arrowhead-palette'),
					elm$svg$Svg$Attributes$viewBox('0 0 15 15'),
					elm$svg$Svg$Attributes$refX('7'),
					elm$svg$Svg$Attributes$refY('5'),
					elm$svg$Svg$Attributes$markerWidth('6'),
					elm$svg$Svg$Attributes$markerHeight('6'),
					elm$svg$Svg$Attributes$orient('auto-start-reverse')
			...
			_List_fromArray(
				[
					...
					elm$svg$Svg$Attributes$fillOpacity('0.0'),
					elm$svg$Svg$Attributes$stroke('black'),
					elm$svg$Svg$Attributes$points(polylineUnderConstruction),
					elm$svg$Svg$Attributes$strokeWidth('1'),
					elm$svg$Svg$Attributes$markerEnd('url(#arrowhead)')
				]),
			_List_Nil),
			...
			_List_fromArray(
				[
					...
					function () {
						if (pointUnderCursorCoords.$ === 'Just') {
							return 'inherit';
						} else {
							return 'none';
						}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Background$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 252, 252, 252))
			]),
		_List_fromArray(
			[
				A2(
						...
						A2(
							...
							_List_fromArray(
								[
									elm$svg$Svg$Attributes$fill('white'),
									elm$svg$Svg$Attributes$fillOpacity('0.0'),
									elm$svg$Svg$Attributes$stroke('rgb(64, 64, 64)'),
									elm$svg$Svg$Attributes$strokeWidth('3'),
									elm$svg$Svg$Attributes$x('13'),
						...
						A2(
							...
							_List_fromArray(
								[
									...
									elm$svg$Svg$Attributes$stroke('rgb(64, 64, 64)'),
									elm$svg$Svg$Attributes$strokeWidth('3'),
									elm$svg$Svg$Attributes$points('12,28 28,12'),
									elm$svg$Svg$Attributes$markerEnd('url(#arrowhead-palette)')
								]),
							_List_Nil))
					]))
			]));
...
var author$project$Main$itemPropertyPanel = function (item) {
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A3(mdgriffith$elm_ui$Element$rgb255, 196, 196, 196))
					]),
				mdgriffith$elm_ui$Element$text(label)));
	};
	var fieldLabel = function (label) {
		return A2(
	...
	var textField = F4(
		function (onChange, text, placeholder, label) {
			return A2(
...
var author$project$Main$propertyPanel = function (model) {
	return A2(
		...
		function () {
			var _n0 = model.selectedItems;
			if (!_n0.b) {
				return _List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('No item selected')
					]);
			} else {
				if (!_n0.b.b) {
					var item = _n0.a;
					...
					return _List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Multiple items selected')
						]);
				}
			}
		}());
								...
								[
									...
									A2(
										...
										_List_fromArray(
											[
												mdgriffith$elm_ui$Element$width(
												mdgriffith$elm_ui$Element$px(5000)),
												mdgriffith$elm_ui$Element$height(
												mdgriffith$elm_ui$Element$px(2000)),
												mdgriffith$elm_ui$Element$Font$family(
												_List_fromArray(
