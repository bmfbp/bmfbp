...
(in-package :arrowgrams/compiler/OUTPUT-PINS)

; (:code OUTPUT-PINS (:fb :go) (:add-fact :done :request-fb :error) #'arrowgrams/compiler/OUTPUT-PINS::react #'arrowgrams/compiler/OUTPUT-PINS::first-time)
...
(defmethod output-pins ((self e/part:part))
  (let ((fb
         (append
