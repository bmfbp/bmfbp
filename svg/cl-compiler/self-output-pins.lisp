...
(in-package :arrowgrams/compiler/SELF-OUTPUT-PINS)

; (:code SELF-OUTPUT-PINS (:fb :go) (:add-fact :done :request-fb :error) #'arrowgrams/compiler/SELF-OUTPUT-PINS::react #'arrowgrams/compiler/SELF-OUTPUT-PINS::first-time)
