...
(defmethod find-metadata ((self e/part:part))
  (let ((rule '(
                ...
                (:lisp (metadata-inside-bounding-box
                        ...
                        (:? text-id) (:? tL) (:? tT) (:? tR) (:? tB)))
                (:component (:? main-id))
(:lisp (arrowgrams/compiler/util::printf 22))
                (:lisp (arrowgrams/compiler/util::retract (:rect (:? box-id))))
(:lisp (arrowgrams/compiler/util::printf 20))
                (:lisp (arrowgrams/compiler/util::asserta (:used (:? text-id))))
(:lisp (arrowgrams/compiler/util::printf 25))
                (:lisp (arrowgrams/compiler/util::asserta (:log (:? text-id) :is-metadata)))
(:lisp (arrowgrams/compiler/util::printf 21))
                (:lisp (arrowgrams/compiler/util::asserta (:roundedrect (:? box-id))))
(:lisp (arrowgrams/compiler/util::printf 23))
                (:lisp (arrowgrams/compiler/util::asserta (:parent (:? main-id) (:? box-id))))
(:lisp (arrowgrams/compiler/util::printf 24))
(:lisp (arrowgrams/compiler/util::printf 244))
)))
