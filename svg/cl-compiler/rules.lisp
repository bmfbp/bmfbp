...
(defconstant +rules+
  '(
    ((:CALC_BOUNDS_MAIN) (:lisp (true)) (:CREATEBOUNDINGBOXES) (:lisp (true)) (:lisp (true)))
    ...
    ((:CREATEELLIPSEBOUNDINGBOX (:? ID))
     ...
     (LISP (ASSERTA '(:BOUNDING_BOX_RIGHT (:? ID) (:? RIGHT))))
     (LISP (ASSERTA '(:BOUNDING_BOX_BOTTOM (:? ID) (:? BOTTOM)))))
    ((:ASSIGN_PARENTS_TO_ELLISPSES_MAIN) (:lisp (true)) (:ELLIPSE (:? ELLIPSEID)) (:MAKEPARENTFORELLIPSE (:? ELLIPSEID)) (:lisp (true)) (:lisp (true)))
    ((:MAKEPARENTFORELLIPSE (:? ELLIPSEID)) (:COMPONENT (:? COMP)) (LISP (ASSERTA '(:PARENT (:? COMP) (:? ELLIPSEID)))))
    ((:FIND_COMMENTS_MAIN) (:lisp (true)) (:CONDCOMMENT) (:lisp (true)) (:lisp (true)))
    ...
    ((:CREATECOMMENTS (:? _)) (LISP (ASSERTA '(:LOG :\'FATAL\' :COMMENTFINDERFAILED))) (:lisp (true)))
    ((:TEXTCOMPLETELYINSIDEBOX (:? TEXTID) (:? BUBBLEID)) (:POINTCOMPLETELYINSIDEBOUNDINGBOX (:? TEXTID) (:? BUBBLEID)))
    ((:FIND_METADATA_MAIN) (:lisp (true)) (:CONDMETA) (:lisp (true)) (:lisp (true)))
    ...
    ((:ADD_KINDS_MAIN) (:lisp (true)) (:CONDDOKINDS) (:lisp (true)) (:lisp (true)))
    ...
    ((:ADD_SELFPORTS_MAIN) (:lisp (true)) (:CONDELLIPSES) (:lisp (true)) (:lisp (true)))
    ...
    ((:MAKE_UNKNOWN_PORT_NAMES_MAIN) (:lisp (true)) (:UNUSED_TEXT (:? TEXTID)) (:CREATEPORTNAMEIFNOTAKINDNAME (:? TEXTID)) (:lisp (true)) (:lisp (true)))
    ...
    ((:MAKEPAIRID (:? PORTID) (:? NEWID))
     ...
     (LISP (INC-COUNTER)))
    ((:MARKINDEXEDPORTS_MAIN) (:lisp (true)) (:PORTNAME (:? P) (:? _)) (:MARKNAMED (:? P)) (:lisp (true)) (:lisp (true)))
    ...
    ((:COINCIDENTPORTS_MAIN) (:lisp (true)) (:COINCIDENTSINKS) (:COINCIDENTSOURCES) (:lisp (true)) (:lisp (true)))
    ...
    ((:MATCH_PORTS_TO_COMPONENTS_MAIN) (:lisp (true)) (:MATCH_PORTS) (:lisp (true)) (:lisp (true)))
    ...
    ((:PINLESS_MAIN) (:lisp (true)) (:ELTYPE (:? PARENTID) :BOX) (:CHECK_HAS_PORT (:? PARENTID)) (:lisp (true)) (:lisp (true)))
    ...
    ((:SEM_PARTSHAVESOMEPORTS_MAIN) (:lisp (true)) (:ELTYPE (:? PARTID) :BOX) (:CHECK_HAS_PORT (:? PARTID)) (:lisp (true)) (:lisp (true)))
    ...
    ((:SEM_PORTSHAVESINKORSOURCE_MAIN) (:lisp (true)) (:PORT (:? PORTID)) (:HASSINKORSOURCE (:? PORTID)) (:lisp (true)) (:lisp (true)))
    ...
    ((:SEM_NODUPLICATEKINDS_MAIN) (:lisp (true)) (:ELTYPE (:? RECTID) :BOX) (:CHECK_HAS_EXACTLY_ONE_KIND (:? RECTID)) (:lisp (true)) (:lisp (true)))
    ...
    ((:SELFINPUTPINS_MAIN) (:lisp (true)) (:CONDSOURCEELLIPSE) (:lisp (true)) (:lisp (true)))
    ...
    ((:MAKESELFINPUTPINS (:? ELLIPSEID))
     ...
     :!)
    ((:SELFOUTPUTPINS_MAIN) (:lisp (true)) (:CONDSINKELLIPSE) (:lisp (true)) (:lisp (true)))
    ...
    ((:MAKESELFOUTPUTPINS (:? ELLIPSEID))
     ...
     :!)
    ((:INPUTPINS_MAIN) (:lisp (true)) (:CONDSINKRECT) (:lisp (true)) (:lisp (true)))
    ...
    ((:OUTPUTPINS_MAIN) (:lisp (true)) (:CONDSOURCERECT) (:lisp (true)) (:lisp (true)))
    ...
    ((:DUMPLOG (:? T) (:? U) (:? V) (:? W) (:? X) (:? Y) (:? Z))
     ...
     (:WSPC)
     (:WEN (:? Z)))
    ((:DUMPLOG (:? _) (:? _) (:? _) (:? _) (:? _) (:? _) (:? _)) (:lisp (true)))
    ((:DUMPLOG (:? S) (:? T) (:? U) (:? V) (:? W) (:? X) (:? Y) (:? Z))
     ...
     (:WSPC)
     (:WEN (:? Z)))
    ((:DUMPLOG (:? _) (:? _) (:? _) (:? _) (:? _) (:? _) (:? _) (:? _)) (:lisp (true)))
    ((:DUMPLOG (:? R) (:? S) (:? T) (:? U) (:? V) (:? W) (:? X) (:? Y) (:? Z))
     ...
     (:WSPC)
     (:WEN (:? Z)))
    ((:DUMPLOG (:? _) (:? _) (:? _) (:? _) (:? _) (:? _) (:? _) (:? _) (:? _)) (:lisp (true)))
    ((:WSPC) (LISP (out-space)))
    ((:NLE) (LISP (out-nl)))
