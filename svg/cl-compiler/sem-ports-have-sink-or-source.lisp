...
(in-package :arrowgrams/compiler/SEM-PORTS-HAVE-SINK-OR-SOURCE)

; (:code SEM-PORTS-HAVE-SINK-OR-SOURCE (:fb :go) (:add-fact :done :request-fb :error) #'arrowgrams/compiler/SEM-PORTS-HAVE-SINK-OR-SOURCE::react #'arrowgrams/compiler/SEM-PORTS-HAVE-SINK-OR-SOURCE::first-time)
