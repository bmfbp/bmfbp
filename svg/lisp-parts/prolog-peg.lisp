...
(peg:rule prolog::pClause "pCall / pTrue / pFalse / pCut / pHalt / pExpr / pAssertaClause / pRetractClause / pNotClause / pAssignClause / pReadFBClause / pWriteFBClause / pForallClause"
  (:lambda (x) x))
