...
(defrule tNotSquote (and (esrap:! #\') character))
...
(defun ll-test ()
  ...
  (pprint (parse 'tIdentComma "a,")))

(defrule tA #\a)
(defrule tTwoA (and tA tA))
#+nil(defrule tAWithOptionalA (and tA #\, (* tA)))
(defrule tAWithOptionalA (and tA tComma (* tA)))

(defun xx ()
  (pprint (parse 'tA "a"))
  (pprint (parse 'tTwoA "aa"))
  (pprint (parse 'tIdent "a"))
  (pprint (parse 'tIdent "aa"))
  (pprint (parse 'tAWithOptionalA "a,"))
  (pprint (parse 'tAWithOptionalA "a,a"))
  (pprint (parse 'tAWithOptionalA "a,aa"))
)