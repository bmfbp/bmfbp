...
"
  ...
  (DEFMETHOD UNPARSE-STRING-LIST-UNPARSE
    ((U PARSER))
    (LET () (UNPARSE-FOREACH-IN-LIST U #'(LAMBDA (U) (LET () (UNPARSE-EMIT-TOKEN U :STRING) (LET () (UNPARSE-CALL-EXTERNAL U #'SEND-TOP)))))))
  (DEFMETHOD UNPARSE-PARTS-UNPARSE ((U PARSER)) (LET () (UNPARSE-FOREACH-IN-TABLE U #'(LAMBDA (U) (LET () (UNPARSE-CALL-RULE U #'UNPARSE-PART-UNPARSE))))))
                 ...
                 (LET ()
                   ...
                   (LET ()
                     (UNPARSE-FOREACH-IN-TABLE
                      U
                      #'(LAMBDA (U) (LET () (UNPARSE-CALL-EXTERNAL U #'FIND-SINK-PART-PIN-IN-WIRES) (LET () (UNPARSE-CALL-EXTERNAL U #'EMIT-WIRE-IF)))))
                     (LET () (UNPARSE-POP U)))))))
               ...
               (LET ()
                 ...
                 (LET ()
                   ...
                   (LET ()
                     (UNPARSE-FOREACH-IN-TABLE
                      U
                      #'(LAMBDA (U) (LET () (UNPARSE-CALL-EXTERNAL U #'FIND-SOURCE-PART-PIN-IN-WIRES) (LET () (UNPARSE-CALL-EXTERNAL U #'EMIT-WIRE-IF)))))
                     (LET () (UNPARSE-POP U)))))))
          (LET () (UNPARSE-EMIT-TOKEN U :END) (LET () (UNPARSE-POP U)))))))
