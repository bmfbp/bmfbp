...
(DEFMETHOD UNPARSE-STRING-LIST-UNPARSE
           ((U PARSER))
  (LET () (UNPARSE-FOREACH-IN-LIST U
                                   #'(LAMBDA ()
                                       (LET () (UNPARSE-EMIT-TOKEN U :STRING) (LET () (UNPARSE-CALL-EXTERNAL U #'SEND-TOP)))))))

(DEFMETHOD UNPARSE-PARTS-UNPARSE ((U PARSER))
  (LET () (UNPARSE-FOREACH-IN-TABLE U #'(LAMBDA () (LET () (UNPARSE-CALL-RULE U #'UNPARSE-PART-UNPARSE))))))
