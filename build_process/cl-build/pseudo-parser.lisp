...
(defun pseudo-parser (peg-filename pseudo-filename &key (debug nil))
  ...
  (let ((parser-builder-net (arrowgrams/clparts::parser-builder))) ;; this call add parts to the dispatcher list
    ...
    (let ((net
           (cl-event-passing-user::@defnetwork 
            ...
            (:code pseudo-parser (:debug-grammar :source-to-be-parsed :lisp-parser-source) (:pass2-source-out :fatal) #'pseudo-parser-reactor)
            ...
            (:schem TOP (:peg-source-file-name :pseudo-source-file-name :debug-grammar) (:pass2-source-out :fatal-error)
             ...
             ((((:self :peg-source-file-name)) ((pbuilder :peg-source-file-name)))
              ...
              (((pseudo-parser :lisp-source-out)) ((:self :lisp-source-out)))
...
(defmethod try-to-parse ((self e/part:code))
  ...
  (when (and
    ...
    (let ((resulting-lisp (esrap:parse 'arrowgrams/build/cl-build::pseudo
                                       arrowgrams/build/cl-build/globals::*pseudo-source*)))
