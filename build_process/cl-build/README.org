...
#+begin_src lisp :results output
  (arrowgrams/build::build
   (asdf:system-relative-pathname :arrowgrams "build_process/parts/diagram/make-esa-compiler-esa-compiler.svg")
   (asdf:system-relative-pathname :arrowgrams "build_process/parts/graphs/helloworld.graph.json")
   (asdf:system-relative-pathname :arrowgrams "build_process/parts/graphs/helloworld.graph.lisp"))
  (princ (get-universal-time))
#+end_src
* build helloworld
#+name: arrowgrams
