...
"WARNING FB: fact already exists (USED ID2525)"
retract (:RECT :ID2522)
...
,**** initially
,**** run phase
g "string-join" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::STRING-JOIN {10027609D3}>
g "world" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::WORLD {100269B553}>
g "hello" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::HELLO {10025C6903}>
react node "TOP"
