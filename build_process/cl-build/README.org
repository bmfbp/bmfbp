...
#+RESULTS: arrowgrams
: "1, rephrase ready" 3794162311

#+name: arrowgrams
#+header: :var message="1, rephrase ready"
#+begin_src lisp
  (ql:quickload :arrowgrams/rephrase-compiler)
  (format nil "~s ~s" message (get-universal-time))
#+end_src
#+name: arrowgrams
#+header: :var message="2. esa ready"
#+begin_src lisp
  (ab::make-esa-dsl)
...
#+end_src
#+name: arrowgrams
#+header: :var message="3a. esa.lisp generated"
#+begin_src lisp
  (ab::make-esa)
  (format nil "~s ~s" message (get-universal-time))
#+end_src
#+name: arrowgrams
#+header: :var message="3b. build ready"
#+begin_src lisp
  (ql:quickload :arrowgrams/build)
  (format nil "~s ~s" message (get-universal-time))
#+end_src
#+name: arrowgrams
#+header: :var message="4. test run finished"
#+begin_src lisp
  (ab::test-hw)
  (format nil "~s ~s" message (get-universal-time))
#+end_src
...
not needed, after graph has been captured
#+name: arrowgrams
