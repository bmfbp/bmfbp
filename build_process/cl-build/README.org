...
**  1a. clone pt repos
   cd quicklisp/local-projects/<clean-directory>
   git clone git@github.com:guitarvydas/cl-event-passing.git
   git clone git@github.com:guitarvydas/cl-holm-prolog.git
   git clone git@github.com:guitarvydas/loops.git
   git clone git@github.com:guitarvydas/cl-peg.git
   git clone git@github.com:guitarvydas/sl.git
**  1b. clone arrowgrams repo
   git clone git@github.com:bmfbp/bmfbp.git
...
** 4. edit and repeat
   ...
   os> sbcl
   sbcl> (arrowgrams/build::helloworld)
** (5.) Edit results, if you want to see the graph
   edit ~/quicklisp/local-projects/bmfbp/build_process/cl-build/helloworld.graph.json
