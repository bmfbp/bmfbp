...
#+RESULTS: arrowgrams
#+begin_example
drawio :SVG-FILENAME #P"/Users/tarvydas/quicklisp/local-projects/bmfbp/build_process/parts/diagram/worldhello.svg"
front-end-main gets #P"/Users/tarvydas/quicklisp/local-projects/bmfbp/build_process/parts/diagram/worldhello.svg"
...
"WARNING FB: fact already exists (USED ID2606)"
retract (:RECT :ID2603)
...
build-graph-in-memory pushes "graph" "worldhello"
...
(((:ITEM-KIND . "leaf") (:NAME . "hello") (:IN-PINS "start")
 ...
 ((:ITEM-KIND . "graph") (:NAME . "worldhello")
  (:GRAPH (:NAME . "WORLDHELLO") (:INPUTS "START") (:OUTPUTS "RESULT")
...
,**** initially
,**** run phase
g "string-join" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::STRING-JOIN {100564C553}>
g "world" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::WORLD {100558E323}>
g "hello" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::HELLO {10054F14F3}>
react node "TOP"
...
cl-event-passing terminating - ready list is nil
#+end_example
* build helloworld3
#+name: arrowgrams
