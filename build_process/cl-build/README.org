...
"WARNING FB: fact already exists (USED ID1513)"
retract (:RECT :ID1510)
...
,**** initially
,**** run phase
g "string-join" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::STRING-JOIN {100B149253}>
g "world" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::WORLD {100B00BCC3}>
g "hello" input-queue NIL output-queue NIL self #<ARROWGRAMS/BUILD::HELLO {100ADDF293}>
react node "TOP"
react "world"
