...
(defclass parser (e/part:code)
  ((token-stream :accessor token-stream :initarg :token-stream :initform nil) ;; actually, just a list
   (output-stream :accessor output-stream :initarg :output-stream :initform (make-string-output-stream)) ;; for rp
   (cl-stream :accessor cl-stream :initarg :output-stream :initform (make-string-output-stream))
   (js-stream :accessor js-stream :initarg :output-stream :initform (make-string-output-stream))
