...
(defclass strcat5 (e/part:code) 
  ((state :accessor state)
   (x :accessor x)
   (y :accessor y)))

(defmethod e/part:busy-p ((self strcat5))
  (call-next-method))

(defmethod e/part:clone ((self strcat5))
  (call-next-method))

(defmethod e/part:first-time ((self strcat5))
  (setf (state self) :idle)
  (setf (x self) "")
  (setf (y self) ""))

(defmethod e/part:react ((self strcat5) (e e/event:event))
  (ecase (state self)
    (:idle
...
(defmethod send-result ((self strcat5))
