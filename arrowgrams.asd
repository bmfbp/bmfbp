...
(defsystem :arrowgrams/make-esa
    ...
    :around-compile (lambda (next)
                      ...
                      (funcall next))
    :components ((:module "source"
                          :pathname "./build_process/make-esa-compiler"
                          :components ((:file "esa-dsl")
                                       (:file "esa-parser")))))

(defsystem :arrowgrams/deprecated-esa
    :depends-on (:arrowgrams/rephrase-compiler)
    :around-compile (lambda (next)
                      (proclaim '(optimize (debug 3)
                                  (safety 3)
...
(defsystem :arrowgrams/deprecated-build
  :depends-on (:arrowgrams/make-esa :cl-ppcre :cl-json :loops :cl-holm-prolog :arrowgrams/v4compiler)
  :around-compile (lambda (next)
                    (proclaim '(optimize (debug 3) (safety 3) (speed 0)))
                    (funcall next))
...
(defsystem :arrowgrams/make-esa-compiler
    :depends-on (:arrowgrams/cl-event-passing-no-esrap :alexandria)
    :around-compile (lambda (next)
                      (proclaim '(optimize (debug 3)
                                  (safety 3)
    ...
    :components ((:module "source"
				       ...
				       (:file "rp-macros" :depends-on ("token" "classes"))
				       (:file "rp-parser" :depends-on ("rp-macros" "token" "classes"))
					      ...
					      :depends-on ("package"
							   ...
							   "rp-parser"
                                                           "error-manager"
							   "tokenize" "comments" "raw-text" 
							   "strings" "spaces"
							   "symbols" "integers"))

				       (:file "rp-rules" :depends-on ("parser-mechanisms"))
				       (:file "make-esa-compiler-schem" 
					      :depends-on ("parser-mechanisms"))
                                       (:file "make-esa-compiler" 
					      :depends-on ("make-esa-compiler-schem"))))))

(defsystem :arrowgrams/use-esa
    :depends-on (:arrowgrams/make-esa-compiler)
    :around-compile (lambda (next)
                      (proclaim '(optimize (debug 3)
                                  (safety 3)
                                  (speed 0)))
                      (funcall next))
    :components ((:module "source"
                          :pathname "./build_process/use-esa"
                          :components ((:file "package")
				       ...
				       (:file "rp-macros" :depends-on ("token" "classes"))
				       (:file "rp-parser" :depends-on ("rp-macros" "token" "classes"))
                                       (:file "esa-parser" :depends-on ("token" "classes"))
                                       (:file "esa-dsl" :depends-on ("token" "classes"))
				       ...
				       (:file "esa-schem" :depends-on ("parser-mechanisms"))))))

(defsystem :arrowgrams/build
  :depends-on (:arrowgrams/use-esa :cl-ppcre :cl-json :loops :cl-holm-prolog :arrowgrams/v4compiler)
  :around-compile (lambda (next)
                    (proclaim '(optimize (debug 3) (safety 3) (speed 0)))
                    (funcall next))
  :components ((:module "arrowgrams-builder"
