...
findClosestTextForPort(PortID,Pairs,Ns,I,Min,Position,UnassignedTextID) :-
...
test(Pairs,N,I,Min,Position,UnassignedTextID) :-
    findClosestTextForPort(id423,Pairs,N,I,Min,Position,UnassignedTextID).
