...
(defun test-macro ()
  ...
  (let ((net
         (cl-event-passing-user::@defnetwork 
          main ;; TODO: is this ALWAYS the same as the last declaration?
          (:part (parser-builder) pbuilder (:peg-source-file-name) (:lisp-source-out :fatal-error))
          (:schem main (:peg-source-file-name) (:lisp-source-out)
        ...
        (peg-filename (asdf:system-relative-pathname :arrowgrams/clparts "clparts/test.peg")))
    (cl-event-passing-user::@send net (e/part::get-input-pin net :peg-source-file-name) peg-filename)))
